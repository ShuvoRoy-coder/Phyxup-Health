...
<template>
    <section class="w-full">
        <div class="relative bg-sectionBg1 py-10">
            <motion.div 
                :initial="{ opacity: 0, y: 50 }"
                :inView="{ opacity: 1, y: 0, transition: { duration: 0.6, ease: 'easeOut' } }"
                :viewport="{ once: false, amount: 0.3 }"
                class="max-w-[1750px] mx-auto px-4 sm:px-10 xl:px-20">
                <!-- Heading -->
                ...
                <motion.div 
                    ...
                    <div class="w-full lg:w-[28%] space-y-4">
                        ...
                        <SectionTitle>
                            AI-Assisted Monitoring Between Visits
                        </SectionTitle>
                        ...
                        <SectionSubTitle>
                            ...
                            predicts likely outcomes, and flags concerns before they impact
                            progress.
                        </SectionSubTitle>
                    </div>
                        ...
                        <div class="rounded-2xl shadow-xl overflow-hidden
                            ...
                            <div class="w-full sm:px-[18px] sm:py-[20px] md:px-[30px] md:py-[32px]">
                                <div class="rounded-2xl py-4 px-4 md:py-4 md:px-[18px] overflow-hidden sm:bg-white/20">
                                    <div class="rounded-2xl p-3 md:p-4 bg-white aspect-video">
                                        <video src="https://www.w3schools.com/tags/movie.mp4" loop muted playsinline
                ...
                <motion.div 
                    ...
                    <div class="flex flex-col md:flex-row items-center gap-[10px] md:gap-[2.3cqw]">
                        <SmartMonitoringButton :active="true" @click="showAlert">
                            <span>
                                AI MONITORING
                            </span>
                            <svg class="size-[28px] md:size-[3cqw]" viewBox="0 0 27 28" fill="none"
                        ...
                        <SmartMonitoringButton @click="showAlert">
                            <span>
                                AI RECOMMENDATION
                            </span>
                            <svg class="size-[28px] md:size-[3cqw]" viewBox="0 0 29 32" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
        ...
        <svg class="max-w-[1663px] mx-auto rotate-180 -translate-y-0.5" viewBox="0 0 1663 127" fill="none"
            xmlns="http://www.w3.org/2000/svg">
